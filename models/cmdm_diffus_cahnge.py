...
class CMDM(nn.Module):
    ...
    def __init__(self, cfg: DictConfig, *args, **kwargs):
        ...
        self.use_cfg = getattr(cfg, 'use_cfg', False)
        self.cfg_dropout_prob = getattr(cfg, 'cfg_dropout_prob', 0.1)  # 训练时丢弃条件的概率
